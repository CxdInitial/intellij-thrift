...
struct SomeStruct1{
1: i32 someField1,3: i32 someField2 xsd_nillable xsd_attrs {
1: i32 someAttr1
}(someAnno="val")
...
exception AnnotatedException{1:i32 code}(deprecated)
...
void longMethod2(1:string someVeryLongArgumentName1,2:i64 anotherVeryLongArgumentName2,3:string thirdVeryLongArgumentName3,4:i64 fourthVeryLongArgumentName4,5:string fifthVeryLongArgumentName5,6:i64 sixthVeryLongArgumentName6)throws(1:SomeException sexc1,25:SomeException sexc3 xsd_attrs {1:string someAttr})(deprecated)
...
struct SomeRequest{1:string field1 2:string field2}

const SomeRequest request={"field1":"value","field2":"value","field3":"value"};

enum SomeEnum{field1=1,field2=2,field3=3}
